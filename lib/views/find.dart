...
import 'package:flutter_application_1/modal/user.dart';
import 'package:flutter_application_1/services/database.dart';
import 'package:flutter_application_1/views/chatscreen.dart';
import 'package:flutter_application_1/views/conversationscreen.dart';
...
class _SearchState extends State<Search> {
  ...
  QuerySnapshot searchResultSnapshot;    // replace () old
  ...
  Widget userList(){
    return haveUserSearched ? ListView.builder(
        ...
        itemBuilder: (context, index){
          return userTile(
            searchResultSnapshot.docs[index].data["userName"],  // documents >> docs
